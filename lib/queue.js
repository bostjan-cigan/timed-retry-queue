...
var TimedRetryQueue = /** @class */ (function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.executeTask(task, tries, true)];
                    case 2:
                        result = _b.sent();
     ...
     */
    TimedRetryQueue.prototype.executeTry = function (task, firstExecution) {
        var _a;
        return __awaiter(this, void 0, void 0, function () {
            var args, interval;
            var _this = this;
     ...
     */
    TimedRetryQueue.prototype.executeTask = function (task, limit, first) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.executeTry(task, first).catch(function (e) { return e; })];
                    case 1:
                        result = _a.sent();
